...
public class RegisterPageAndroid {
    ...
    public RegisterPageAndroid (WebDriver driver) { PageFactory.initElements(new AppiumFieldDecorator(driver), this); }
    ...
    public void setCheckTC() { checkTC.click();}
    public void setCheckNS() { checkNS.click();}
    public void clickOnRegisterButton() {createAccountButton.click();}
